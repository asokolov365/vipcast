...
// findAdvertiseAddress attempts to clone logic from deep within memberlist
...
func findAdvertiseAddress(bindAddr, advertiseAddr string, allowInsecureAdvertise bool) (net.IP, error) {
	if advertiseAddr != "" {
